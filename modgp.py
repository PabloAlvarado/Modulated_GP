...
class ModGP(GPflow.model.Model):
    def __init__(self, X, Y, kern1, kern2, kern3, Z):
        GPflow.model.Model.__init__(self)
        self.X, self.Y, self.kern1, self.kern2, self.kern3 = X, Y, kern1, kern2, kern3
    ...
    def build_likelihood(self):
        ...
        fmean, fvar = tf.concat(1, [fmean1, fmean2, fmean3]), tf.concat(1, [fvar1, fvar2, fvar3])
